import 'package:almahaba/Forgot%20Password/Enter%20code/custom_enter_code.dart';
...
class CustomEnterEmail extends StatelessWidget {
  const CustomEnterEmail({super.key});
                ...
                SubmitButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => const CustomEnterCode()),
                    );
                  },
                  text: 'Send',
                ),
